    ...
    body: isLoading
        ...
        : SingleChildScrollView( // Wrap the content with SingleChildScrollView
            child: Padding(
              ...
              child: Column(
                children: [
                  // Lottie animation with bigger size
                  Lottie.network(
                    'https://lottie.host/37524fe7-2d55-4c10-bdfc-2d754755aef3/p1JLay6UNp.json',
                    height: 350, // Increased height for bigger animation
                  ),
                  const SizedBox(height: 30), // Added space between animation and input section
                  Container(
